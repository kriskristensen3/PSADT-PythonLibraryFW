...
Try {
    ...
    [String]$appScriptDate = '30/10/2024'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Set-RegistryKey -Key "HKEY_LOCAL_MACHINE\SOFTWARE\PythonLibraryFW\$($PythonPkg)" -Name 'PythonPkg' -Value $PythonPkg -Type String
		If($PkgVersion -ne ""){
			Set-RegistryKey -Key "HKEY_LOCAL_MACHINE\SOFTWARE\PythonLibraryFW\$($PythonPkg)" -Name 'Version' -Value $PkgVersion -Type String
		}Else{
			Set-RegistryKey -Key "HKEY_LOCAL_MACHINE\SOFTWARE\PythonLibraryFW\$($PythonPkg)" -Name 'Version' -Value Latest -Type String
		}
